...
public class JDBCManager {
    ...
    /**
     * Проверяет строку на null значение
     * @param string  String поле продукта
     */
    ...
    /**
     * Возвращает ID последнего продукта
     */
    public static Integer getLastFoodID() throws SQLException {
        int lastFoodID = 0;
     ...
     * @param foodId ID продукта
     */
    public static void checkInsert(Integer foodId) throws SQLException {
